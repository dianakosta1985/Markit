    ...
    <Paper sx={{ width: "35%", p: 4 }}>
      <Grid container>
        <Grid
          ...
          alignItems="center"
          xs={12}
          sx={{ borderBottom: `2px solid ${Theme.mainColor} `, py: 4 }}
        >
          <Autocomplete
            aria-label="input"
            sx={{ width: "50%" }}
            options={SymbolArr.map((option) => option.label)}
            onInputChange={(e: React.FormEvent<EventTarget>, v: string) =>
        ...
        >
          ...
          <StyledTypography
            ...
            fontSize={"20px"}
            color={`${
              quote.Change > 0 ? Theme.positiveColor : Theme.negativeColor
            }`}
          >
            {`${quote.Change > 0 ? "+" : ""}${getRoundVal(quote.Change)}`}
          </StyledTypography>
          <StyledTypography
            paddingRight={"5px"}
            fontSize={"20px"}
          ...
          >
            {`(${quote.ChangePercent > 0 ? "+" : ""}${getRoundVal(
              quote.ChangePercent
            )})%`}
          </StyledTypography>
        </Grid>
        ...
        <Grid container xs={12}>
          ...
          <StyledGrid
            item
            xs={12}
            sx={{ borderBottom: `1px solid ${Theme.mainColor}` }}
          >
            <StyledTypography color={Theme.mainColor}>
              Market Cap
            </StyledTypography>
            <StyledTypography fontWeight={"600"}>
